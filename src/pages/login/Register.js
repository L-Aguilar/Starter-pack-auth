...
import {crearUsuarioAccion} from '../../redux/authDucks'
...
const Register = () => {
    ...
    const iniciarSesion = (e) => {
        ...
        if(!privacy){
            console.log("Debes aceptar las politicas de privacidad...")
            return
        }

        if(password === passwordDos){
            dispatch(crearUsuarioAccion(email, password, history))
        } else {
                    ...
                    <div className="row justify-content-center">
                        <div className="col-sm-8 col-lg-5">
                            <div className="card shadow zindex-100 mb-0">
                                        ...
                                        <p className="text-muted mb-0">Made with love by developers for developers.</p>
                                            <form className="form mt-5">
                                                ...
                                                <div className="form-group mb-3 form-check">
                                                    ...
                                                    id="exampleCheck1" onChange={(e)=> setTerms(e.target.checked)}/>
                                                    <label className="form-check-label" htmlFor="exampleCheck1">I agree to the <a>terms and conditions</a></label>
                                                </div>

                                                <div className="form-group mb-3 form-check">
                                                    <input type="checkbox" className="form-check-input" 
                                                    id="exampleCheck1" onChange={(e)=> setPrivacy(e.target.checked)}/>
                                                ...
                                                <button
                                                    className="button-accent block mt-5"
                                ...
                                <div className="card-footer px-md-5"><small>Tienes una cuenta? </small>
                                    <a href="/login" className="small font-weight-bold">Iniciar sesión</a>
                                </div>
